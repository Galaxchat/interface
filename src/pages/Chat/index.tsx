...
export default function Chat({ history }: RouteComponentProps) {
  ...
  const account = chatUniSendContract?.signer._address
  ...
  const handleEnter = useCallback(async (e: KeyboardEvent<HTMLInputElement>) => {
    if (enterQuery && chatUniSendContract) {
      chatUniSendContract.on("Send", (chatroom, sender, content, id) => {
        ...
        >
          <AutoColumn gap={"md"}>
            ...
            <AutoRow justify="center" style={{ paddingBottom: '5px' }}>
              ...
              chatRoomAddress='0xe37eBE5884017C3dfbB9187E70976280Ea4202e0'
              account={account}
              />
            </AutoRow>
          </AutoColumn>
